...
<!--                <article class="post">-->
<!--                    <div class="post-thumb">-->
<!--                        <a href="blog.html"><img src="--><?//= $folderMarkup ?><!--/images/abc.jpg" alt=""></a>-->
<!---->
<!--                        <a href="blog.html" class="post-thumb-overlay text-center">-->
<!--                            <div class="text-uppercase text-center">View Post</div>-->
<!--                        </a>-->
...
<!--                <article class="post">-->
<!--                    <div class="post-thumb">-->
<!--                        <a href="blog.html"><img src="--><?//= $folderMarkup ?><!--/images/blog-2.jpg" alt=""></a>-->
<!---->
<!--                        <a href="blog.html" class="post-thumb-overlay text-center">-->
<!--                            <div class="text-uppercase text-center">View Post</div>-->
<!--                        </a>-->
...
<!--                <article class="post">-->
<!--                    <div class="post-thumb">-->
<!--                        <a href="blog.html"><img src="--><?//= $folderMarkup ?><!--/images/blog-3.jpg" alt=""></a>-->
<!---->
<!--                        <a href="blog.html" class="post-thumb-overlay text-center">-->
<!--                            <div class="text-uppercase text-center">View Post</div>-->
<!--                        </a>-->
...
<!--                <article class="post">-->
<!--                    <div class="post-thumb">-->
<!--                        <a href="blog.html"><img src="--><?//= $folderMarkup ?><!--/images/blog-4.jpg" alt=""></a>-->
<!---->
<!--                        <a href="blog.html" class="post-thumb-overlay text-center">-->
<!--                            <div class="text-uppercase text-center">View Post</div>-->
<!--                        </a>-->
