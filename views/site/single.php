            ...
            <div class="col-md-8">
                <article class="post">
                    <div class="post-thumb">
                        <a href="blog.html"><img src="<?= $folderMarkup; ?>/images/blog-1.jpg" alt=""></a>
                    </div>
                ...
                <div class="top-comment"><!--top comment-->
                    <img src="<?= $folderMarkup; ?>/images/comment.jpg" class="pull-left img-circle" alt="">
                    <h4>Rubel Miah</h4>
                ...
                <div class="row"><!--blog next previous-->
                    <div class="col-md-6">
                        <div class="single-blog-box">
                            <a href="#">
                                <img src="<?= $folderMarkup; ?>/images/blog-next.jpg" alt="">
                ...
                <div class="related-post-carousel"><!--related post carousel-->
                    ...
                    <div class="items">
                        <div class="single-item">
                            <a href="#">
                                <img src="<?= $folderMarkup; ?>/images/related-post-1.jpg" alt="">
                        ...
                        <div class="single-item">
                            <a href="#">
                                <img src="<?= $folderMarkup; ?>/images/related-post-2.jpg" alt="">
                        ...
                        <div class="single-item">
                            <a href="#">
                                <img src="<?= $folderMarkup; ?>/images/related-post-3.jpg" alt="">
                ...
                <div class="bottom-comment"><!--bottom comment-->
                    ...
                    <div class="comment-img">
                        <img class="img-circle" src="<?= $folderMarkup; ?>/images/comment-img.jpg" alt="">
                    </div>
                ...
                <div class="primary-sidebar">
                    <aside class="widget">
                        ...
                        <div class="popular-post">
                            ...
                            <a href="#" class="popular-img"><img src="<?= $folderMarkup; ?>/images/p1.jpg" alt="">
                        ...
                        <div class="thumb-latest-posts">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#" class="popular-img"><img src="<?= $folderMarkup; ?>/images/r-p.jpg" alt="">
